...
_load_env() {
  ...
  export WHITELIST_FILE="$ROOT_DIR/config/allowlist/whitelist.txt"
  export ALLOW_ALL_IPS_FILE="$ROOT_DIR/config/allowlist/allow_all_ips.txt"
  export DNSMASQ_WHITELIST="/etc/dnsmasq.d/whitelist.conf"
  export IPSET_SERVICE_DST="/etc/systemd/system/ipset-restore.service"
  export IPSET_SERVICE_SRC="$ROOT_DIR/config/services/ipset-restore.service"
